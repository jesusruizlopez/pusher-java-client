...
public class PusherOptionsTest {
    ...
    public void testDefaultURL() {
        assertEquals(pusherOptions.buildUrl(API_KEY), "wss://ws.pusherapp.com:443/app/" + API_KEY + "?client=java-client&protocol=8&version=" + PusherOptions.LIB_VERSION);
    }

    @Test
    public void testNonSSLURLIsCorrect() {
        pusherOptions.setEncrypted(false);
        assertEquals(pusherOptions.buildUrl(API_KEY), "ws://ws.pusherapp.com:80/app/" + API_KEY + "?client=java-client&protocol=8&version=" + PusherOptions.LIB_VERSION);
    }

    @Test
    public void testClusterSetURLIsCorrect() {
        pusherOptions.setCluster("eu");
        assertEquals(pusherOptions.buildUrl(API_KEY), "wss://ws-eu.pusher.com:443/app/" + API_KEY + "?client=java-client&protocol=8&version=" + PusherOptions.LIB_VERSION);
    }

    @Test
    public void testClusterSetNonSSLURLIsCorrect() {
        pusherOptions.setCluster("eu").setEncrypted(false);
        assertEquals(pusherOptions.buildUrl(API_KEY), "ws://ws-eu.pusher.com:80/app/" + API_KEY + "?client=java-client&protocol=8&version=" + PusherOptions.LIB_VERSION);
    }

    @Test
    public void testCustomHostAndPortURLIsCorrect() {
        pusherOptions.setHost("subdomain.example.com").setWsPort(8080).setWssPort(8181);
        assertEquals(pusherOptions.buildUrl(API_KEY), "wss://subdomain.example.com:8181/app/" + API_KEY + "?client=java-client&protocol=8&version=" + PusherOptions.LIB_VERSION);
    }
    ...
    public void testCustomHostAndPortNonSSLURLIsCorrect() {
        ...
        assertEquals(pusherOptions.buildUrl(API_KEY), "ws://subdomain.example.com:8080/app/" + API_KEY + "?client=java-client&protocol=8&version=" + PusherOptions.LIB_VERSION);
    }
}
